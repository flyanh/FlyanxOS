...
_PROTOTYPE( int (*mm_call_handlers[NR_CALLS]), (void) ) = {
        ...
        &mm_no_sys,     /* 15 = mkdir::创建一个目录项 */
        &mm_no_sys,     /* 16 = stat::获取文件状态 */
        &do_get,        /* 17 = getpid::获取进程自己的进程号 */
        &do_get,        /* 18 = getppid::获取父进程的进程号 */
        &do_waitpid,    /* 19 = waitpid:: */
